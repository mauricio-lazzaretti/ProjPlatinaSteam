...
namespace ProjPlatinaSteam.Interfaces
{
    public interface IJogoService
    {
        ...
        Task SincronizarJogosAsync(List<Jogo> jogosSteam, int usuarioId, string steamId); // Método para sincronizar os jogos do usuário com os dados obtidos da API do Steam
        ...
        Task<List<Jogo>> ObterJogosPrimeiroAcesso(string steamId, int usuarioId);
    }
}
